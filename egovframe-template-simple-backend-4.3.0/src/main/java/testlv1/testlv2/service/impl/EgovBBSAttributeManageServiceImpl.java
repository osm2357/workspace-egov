 ...
 */
@Slf4j
@Service("TestEgovBBSAttributeManageService")
public class EgovBBSAttributeManageServiceImpl extends EgovAbstractServiceImpl implements TestEgovBBSAttributeManageService {

    @Resource(name = "TestBBSAttributeManageDAO")
    private TestBBSAttributeManageDAO attrbMngDAO;
...
//    }
    ...
    log.debug("TestEgovBBSAttributeManageServiceImpl.selectBBSMasterInf start!!!------------------------------------------------------");	
	...
	log.debug("TestEgovBBSAttributeManageServiceImpl.selectBBSMasterInf end!!!------------------------------------------------------");
