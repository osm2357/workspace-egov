 ...
 *  </pre>
 */
@Service("TestEgovBBSManageService")
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements TestEgovBBSManageService {

	@Resource(name = "TestBBSManageDAO")
	private TestBBSManageDAO bbsMngDAO;
