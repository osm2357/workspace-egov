 ...
 */
@Slf4j
@Repository("TestBBSManageDAO")
public class TestBBSManageDAO extends EgovAbstractMapper {
    ...
    public List<BoardVO> selectBoardArticleList(BoardVO boardVO) throws Exception {
    	log.debug("TestBBSManageDAO.selectBoardArticleList start!!!------------------------------------------------------");
		return selectList("TestBBSManageDAO.selectBoardArticleList", boardVO);
	}
    ...
    public int selectBoardArticleListCnt(BoardVO boardVO) throws Exception {
    	log.debug("TestBBSManageDAO.selectBoardArticleListCnt start!!!------------------------------------------------------");
    	return (Integer)selectOne("TestBBSManageDAO.selectBoardArticleListCnt", boardVO);
    }
