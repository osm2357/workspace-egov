 ...
 */
@Slf4j
@Repository("TestBBSAttributeManageDAO")
public class TestBBSAttributeManageDAO extends EgovAbstractMapper {
...
//    }
    ...
    public BoardMasterVO selectBBSMasterInf(BoardMaster vo) throws Exception {
    	log.debug("TestBBSAttributeManageDAO.selectBBSMasterInf start!!!------------------------------------------------------");
    	return (BoardMasterVO)selectOne("TestBBSAttributeManageDAO.selectBBSMasterInf", vo);
    }
