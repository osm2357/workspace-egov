...
import testlv1.testlv2.service.TestEgovBBSAttributeManageService;
import testlv1.testlv2.service.TestEgovBBSManageService;
 ...
 */
@RestController
@Tag(name="TestNoticeApiController",description = "게시물 관리")
@Slf4j
public class TestNoticeApiController {
	
	@Autowired
    private EgovJwtTokenUtil jwtTokenUtil;
    public static final String HEADER_STRING = "Authorization";
    
	@Resource(name = "TestEgovBBSManageService")
	private TestEgovBBSManageService bbsMngService;

	@Resource(name = "TestEgovBBSAttributeManageService")
	private TestEgovBBSAttributeManageService bbsAttrbService;
...
//	}
	...
	public ResultVO selectBoardArticles(
		...
		throws Exception {
		log.debug("TestNoticeApiController.selectBoardArticles start!!!------------------------------------------------------");
		...
		log.debug("TestNoticeApiController.selectBoardArticles end!!!------------------------------------------------------");
